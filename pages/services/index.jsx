...
const Marketing =()=>{
    return(
        <article className="col-service" id="marketing">
            ...
            la <em>mise en avant </em>de votre produit sur les plateformes de recherche, <em>le marketing d&apos;influence </em>ou encore <em>le SEO.</em><br/><br/> 
            Il implique aussi la gestion de votre image en ligne. Plus vous êtes présent et formez une <em>communauté autour de votre 
            marque, </em> plus la confiance et la fidélité de vos clients augmenteront. <br/><br/> 
            Etant très familier des outils utilisés pour<em> développer cette image de marque </em> ou encore pour mettre en avant vos produits, 
            je propose de gérer cette partie de votre business pour vous. 
...
const Inte =()=>{
    return(
        <article className="col-service" id="integration">
            ...
            Je mets en place votre site<em> de A à Z</em>, en utilisant différents process pour arriver à obtenir un site à la navigation <em>fluide et agréable</em> comportant toutes les fonctionalitées dont vous avez besoin au sein de votre projet. <br/><br/>
...
const Seo =()=>{
    return(
        <article className="col-service" id="seo">
            ...
            Différentes techniques sont utilisées: <em>Les backlinks</em> ,<em>Une sémantique propre et claire</em>, des articles pertinents avec un <em>taux de rétention et de clics élevés</em> sur votre site.<br/><br/>
            Une fois mis en place, il offre de la visibilité naturelle et vous permet d&apos;attirer des clients <em>sans débourser un centime. </em><br/><br/>
...
const Design =()=>{
    return(
        <article className="col-service" id="design">
            ...
            <div className="textContent">
                <em>Un bon UX et un bon UI </em>sont les clés d&apos;un site qui convertit. <br/><br/> 
                ...
                Je me tourne généralement vers des schémas que l&apos;utilisateur connait déjà afin de faciliter
    ...
    return(
        ...
        <article className="col-service" id="e-commerce">
            ...
            <div className="textContent">
                ...
                Mais malgré ça, le site a besoin d&apos;<em>inspirer confiance </em>afin d&apos;aider le client <em>à valider son panier ou à souscrire a votre service. </em><br/><br/>
                De simples techniques de design ou d&apos;agencement qui aide a obtenir <em>des taux de conversion plus important</em> existent et je peux vous aider à les mettres en place.<br/><br/>
                J&apos;utilise le <em>CMS Shopify,</em> qui me permet d&apos;assurer des performances optimales pour votre boutique à moindre coût mais reste ouvert à d&apos;<em>autres technologies.</em>
            </div>
            <button className="navContact" ><Link href="./#contact"> Ca m&apos;intéresse</Link></button> 
